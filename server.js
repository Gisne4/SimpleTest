...
mongoose
  .connect(
    "mongodb+srv://dkrkd010:jd5sdFr3IVpXfwZd@krlee.slxnsqd.mongodb.net/?retryWrites=true&w=majority&appName=KRLEE"
  )
...
io.on("connection", (socket) => {
  ...
  socket.on("startGame", async () => {
    ...
    try {
      ...
      room.questions = allQuestions.sort(() => 0.5 - Math.random());
